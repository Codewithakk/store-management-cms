 ...
 * Stock Routes
 */
router.get('/stock/:variantId', authMiddleware, roleRestriction([Role.ADMIN, Role.MANAGER, Role.STAFF]), getVariantStock)

router.put('/stock/:variantId', authMiddleware, roleRestriction([Role.ADMIN, Role.MANAGER, Role.STAFF]), validateStockUpdate, updateStock)

router.get('/stocks', authMiddleware, roleRestriction([Role.ADMIN, Role.MANAGER, Role.STAFF]), listStock)

router.get('/low-stock', authMiddleware, roleRestriction([Role.ADMIN, Role.MANAGER, Role.STAFF]), getLowStock)
